...
const Contact = ()=>{
    ...
    return(<>
     <Flex width={'100vw'}  overflow={'hidden'} alignItems={'center'} position={'absolute'} height={'100vh'}>
        
        <Flex flex='1' py='5vh'  height={'100vh'} bg='brand.gray_1' px='4vw' justifyContent={'center'} flexDir={'column'}    >
            <Box maxH={'100%'}   overflow={'scroll'} > 
        ...
        <Flex flex='1'   position={'relative'} px='4vw'justifyContent={'center'} alignItems={'center'} >
          ...
          <Flex  position='absolute'    opacity={submited ? 0 : 1} pointerEvents={submited ? 'none' : 'all'} transition="opacity 0.3s ease-in-out"  maxW={'800px'} justifyContent={'center'} alignItems={'center'} flexDir={'column'} flex='1'>
            <FormInput placeholder={t('NameSurname')} field={t('ContactBox_1')} value={name} setValue={setName} />
